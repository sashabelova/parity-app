          ...
          if (!this.data[d].axisYType || 'primary' === this.data[d].axisYType)
            if (this.options.axisY && 0 < this.options.axisY.length) {
              ...
              this.axisY.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ? this._axes.push(
                      (this.axisY[0] = new z(this, 'axisY', this.options.axisY, 0, 'axisY', 'left'))
                    )
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisY[0] = new z(
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              ...
              this.axisX.length ||
                ('normal' === this.plotInfo.axisPlacement
                  ...
                  : 'xySwapped' === this.plotInfo.axisPlacement &&
                    this._axes.push(
                      (this.axisX[0] = new z(this, 'axisX', this.options.axisX, 0, 'axisX', 'left'))
                    )),
            ...
            for (var u = !1, t = 0; t < s.length; t++)
              if (
                ...
                if ('number' !== typeof s[t].y)
                  0 < t && !(h.connectNullData || u || p) && (b.stroke(), r && c.stroke()),
                    (u = !0);
                else {
